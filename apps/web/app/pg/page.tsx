        ...
        {noListings ? (
          ...
          <>
            <div className="flex justify-between items-center gap-1 sticky top-0 bg-white z-30 ">
              <div>
                <p className="text-black font-normal text-xs ">- PG - {city.toString()} - {townSector.toString()}</p>
                <p className="text-black font-normal text-xs mb-3 ">- Total PG Search - {listingData?.listings.length}</p>
              </div>
              <div>
                <input
                  type="text"
                      ...
                      <div className="px-4 py-1">
                        ...
                        <div className="mt-0.5 flex justify-start gap-8 md:gap-16 items-center">
                          ...
                          <p className="text-xs md:text-sm text-gray-600 text-center">
                            All PG Prices can be Different
                          </p>
                        </div>
                      </div>
                    </div>
