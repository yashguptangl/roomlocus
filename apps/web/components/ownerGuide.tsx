    ...
    return (
        <div className="mt-4 w-full max-w-2xl mx-auto flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
            ...
            <ul className="space-y-4 list-disc pl-5">
                ...
                <li key={idx} className="text-sm sm:text-base text-blue-400">
                    {text}
                </li>
                ))}
            </ul>
            ...
            <div className="w-full bg-yellow-50 border border-yellow-300 rounded p-4 text-xs text-yellow-800 mt-2">
                {lang === "en" ? (
                    <>
                        <strong>Note:</strong>
                        <br />
