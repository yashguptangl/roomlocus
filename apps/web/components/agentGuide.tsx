                ...
                {lang === "en" ? (
                    <>
                        ...
                        <li className="text-sm sm:text-base text-blue-400">
                            ...
                            <p className="text-sm sm:text-base text-blue-400">Sir, if you get your property verified by an agent, your property will be instantly verified. We will also advertise your property so that more and more customers can reach you.</p>

                            <h3 className="font-semibold text-black">Our Future Plan</h3>
                            <p className="text-sm sm:text-base text-blue-400">According to Roomlocus guidelines, the property verification commission may be set at ₹250, ₹300, ₹400, ₹500, etc.</p>
                            <p className="text-sm sm:text-base text-blue-400">The agent cannot make any claim on Roomlocus or its services</p>
                            <p className="text-sm sm:text-base text-blue-400">Roomlocus may change its policy and terms &amp; conditions from time to time.</p> 
                    </>
                ) : (
                    <>
                        <li className="text-sm sm:text-base text-blue-400">
                        ...
                        <li className="text-sm sm:text-base text-blue-400">
                         ...
                         <li className="text-sm sm:text-base text-blue-400">
                            ...
                            <p className="text-sm sm:text-base text-blue-400">सर, अगर आप एजेंट के द्वारा अपनी प्रॉपर्टी वेरीफाई कराते हैं तो आपकी प्रॉपर्टी तुरंत वेरीफाई हो जाएगी। हम आपकी प्रॉपर्टी की विज्ञापन भी करेंगे जिससे ज्यादा से ज्यादा ग्राहक आप तक पहुंच सकें।</p>

                        
                            <h3 className="font-semibold text-black">Our Future Plan</h3> 
                            <p className="text-sm sm:text-base text-blue-400">Roomlocus की गाइडलाइन के अनुसार Property Verify कमीशन 250, 300, 400, 500 आदि किया जा सकता है।</p>
                            <p className="text-sm sm:text-base text-blue-400">एजेंट Roomlocus या उसकी सर्विस पर किसी भी प्रकार का दावा नहीं कर सकता है।</p>
                            <p className="text-sm sm:text-base text-blue-400">Roomlocus समय-समय पर अपनी पालिसी और टर्म्स एंड कंडीशन बदल सकता है।</p>
